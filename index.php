...
<head>
    ...
    <title>My Digital Card - V2</title>
</head>
...
<body>
    ...
    <main id="home-page-digital-card">
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-lg-6 col-md-6 col-xl-6">
                        ...
                        <div class="extra-decoration-image-left-side">
                            <img class="extra-decoration-image-left-side-one" src="assets/images/round-1.png"
                                alt="My Digital Card">
                    ...
                    <div class="col-lg-6 col-md-6 col-xl-6">
                        <div class="right-side-content-part">
                            ...
                            <h1 class="top-heading-home text-white">ital Banking.</h1>
        ...
        <section class="trusted_by_company margin-bottom-section">
            <div class="container">
                <div class="row">

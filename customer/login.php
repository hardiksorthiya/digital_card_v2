            ...
            <div class="left">
                ...
                <div class="contact">
                    <form action="#" method="post">
                        ...
                        <button type="submit" class="btn btn-primary btn-hp-style login-btn-page">Login</button>
                    </form>
                </div>
                <div class="need-account">Need an account? <span><a href="signup.php">Sign Up</a></span></div>
            </div>
            <div class="right">
